...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        # We use RLDS data loading to make training on this large dataset tractable.
        # For fine-tuning on your own DROID dataset, see below.
        name="paligemma_fast_full_droid_finetune_deltaeef",
        model=pi0_fast.Pi0FASTConfig(
            action_dim=7,
            action_horizon=16,
            max_token_len=180,
        ...
        num_train_steps=250_000,  # 100k steps should be sufficient, takes ~2 days on 8x H100s
        batch_size=256,
        log_interval=100,
        save_interval=5000,
        keep_period=20_000,
    ...
    TrainConfig(
        ...
        # We use RLDS data loading to make training on this large dataset tractable.
        # For fine-tuning on your own DROID dataset, see below.
        name="paligemma_full_droid_finetune",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=16,
    ...
    TrainConfig(
        ...
        # We use RLDS data loading to make training on this large dataset tractable.
        # For fine-tuning on your own DROID dataset, see below.
        name="paligemma_full_droid_finetune_eef",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=16,
