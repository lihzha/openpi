...
_CONFIGS = [
    TrainConfig(
        ...
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://pi0-cot/cache/openpi-assets/checkpoints/pi0_base/params"),
    ...
    TrainConfig(
        ...
        batch_size=256,
        # weight_loader=weight_loaders.PaliGemmaWeightLoader(),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://v6_east1d/cache/openpi-assets/checkpoints/pi0_base/params"),
